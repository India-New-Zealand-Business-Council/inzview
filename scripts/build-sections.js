...
const shell = { nav: NAV, footer: FOOTER };
...
export function pageHtml(name) {
  ...
  return '<!doctype html><html lang="en-NZ"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' + BASE_CSS + '</head><body>' + NAV + body + FOOTER + '</body></html>';
}
